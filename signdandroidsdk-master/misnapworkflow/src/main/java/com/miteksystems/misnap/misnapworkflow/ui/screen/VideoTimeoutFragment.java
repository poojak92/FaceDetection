...
public class VideoTimeoutFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            if (mWillCaptureCheck) {
                ...
                mTutorialImage.setContentDescription(getString(R.string.id_tts_video_timeout_check));
            } else {
                mTutorialImage.setImageResource(R.drawable.misnap_video_timeout_src_document);
                mTutorialImage.setContentDescription(getString(R.string.id_tts_video_timeout_document));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void onResume() {
        super.onResume();
        int spokenTextId = mWillCaptureCheck ? R.string.id_tts_video_timeout_check : R.string.id_tts_video_timeout_document;
